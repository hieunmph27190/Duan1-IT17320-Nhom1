 ...
 */
public class Khachhangx extends javax.swing.JFrame {
...
//    
    ...
    public Customer getform() {
        ...
        try {
            ...
            Logger.getLogger(Khachhangx.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void click(int index) {
        ...
        txtlastname.setText(cuss.getLastName());
...
//            clearForm();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            JFileChooser fileChooser = new JFileChooser("D:\\FPT_Poly\\SOF203\\ASSIGNMENT\\JAVA3_PH21738_Assignment\\src\\view\\img");
            fileChooser.setDialogTitle("Ch?n ?nh");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Khachhangx.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Khachhangx().setVisible(true);
            }
        });
    }
